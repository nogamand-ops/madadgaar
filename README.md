...
| `apps/admin_dashboard` | **Not built.** Currently the default `flutter create` scaffold only — dashboard, live map, pricing panel, unit-economics view and management tables described in the plan were not implemented before the submission deadline. |
